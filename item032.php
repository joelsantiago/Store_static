...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>The Big Lebowski Blu-ray</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/movies/biglebowski.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">The Big Lebowski Blu-ray<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">Jeff "The Dude" Lebowski (Jeff Bridges) doesn't want any drama in his life...heck, he can't even be bothered with a job. But, in a case of mistaken identity, a couple of thugs break into his place and steal his rug (you gotta understand, that rug really tied the room together). Now, The Dude must embark on a quest with his crazy friends to make things right and get that rug back!
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=32" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-3 small-6 columns">
      ...
      <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item030.php">
      <img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/shaunofthedead.gif" width="500" height="500"></a>
      
      <div class="panel">

        <p><a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item030.php">Shaun of the Dead</a></p>
