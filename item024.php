...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>GoPro Hero 3 Silver Edition</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/electronics/hero3/silver/silver-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="#" class="small button expand">Silver</a>
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item025.php" class="small button expand">White</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=24" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hero3/silver/silver-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hero3/silver/silver-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>The HERO3: Silver Edition captures professional quality video at 1080p-30, 720p-60, 960p-48 and WVGA-120 resolutions and frame rates.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hero3/silver/silver-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>The HERO3: Silver Edition features built-in Wi-Fi and is compatible with both the Wi-Fi Remote (optional accessory) and the GoPro App. The Wi-Fi Remote (not included) is a waterproof, wearable remote control that can control up to 50 Wi-Fi-enabled GoPros at a time from a range of 600'. The HERO3: Silver Edition's built in Wi-Fi means it can also be controlled by iOS smartphones and tablets running the GoPro App.</p>
          <!-- InstanceEndEditable -->
