...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>ARB Snatch Strap 33,000LB (ARB715)</title>
    <!-- InstanceEndEditable -->
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">ARB Snatch Strap 33,000LB (ARB715)<hr/></h4>
        <!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item004.php" class="small button expand">24,000LB</a>
            <a href="#" class="small button expand">33,000LB</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=5" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
