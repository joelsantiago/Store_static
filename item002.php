...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>ARB On-Board High Performance 24 Volt Twin Air Compressor (CKMTA24)</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/automotive/arb-compressor-12/ARB-CKMTA12-1.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">ARB On-Board High Performance 24 Volt Twin Air Compressor (CKMTA24)<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">ARB's new CKMTA12 and CKMTA24 twin on-board compressor kits were designed to fill the market need for a compact sized yet high-volume compressed air source to suit the high volume airflow needs of most air powered tools, and also to suit the actuation and control needs of the ARB Air Locker, and the harsh and demanding environment of the ARB Air Locker user.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item001.php" class="small button expand">12-Volt</a>
            <a href="#" class="small button expand">24-Volt</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=2" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/automotive/arb-compressor-12/inflation.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>Ready for constant abuse</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Ducted IP55 sealed brushless DC cooling fan and anodized motor mounting brackets effectively dissipate heat from the motors, heads and electronics allowing for a 100% duty cycle (under room temperature conditions).</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/automotive/arb-compressor-12/inflation2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Built for rugged conditions</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Motors are water sealed, 100% ball bearing equipped (i.e., no bushings used), and feature a unique linear brush pre-load system for extra long life, low heat and quiet operation throughout the life of the unit.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/automotive/arb-compressor-12/locker.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Air locker compatible</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>Full wiring loom included for simplified installation and easy plug-in connectivity to Air Locker control solenoids. (Note: Air Locker Manifold Kit #171503 required to mount solenoids).</p>
          <!-- InstanceEndEditable -->
