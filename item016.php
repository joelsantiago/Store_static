...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Maxxis High Roller Mountain Bike Tire Folding 70a</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/cycling/highroller/hr-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item014.php" class="small button expand">Folding 60a</a>
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item015.php" class="small button expand">Folding 62a</a>
            <a href="#" class="small button expand">Folding 70a</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=16" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/highroller/hr-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>Competition Approved</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Our casings provide more stability at high speeds and also allows for lower air pressure without the risk of pinch flatting. The reliability and stability at speed of our casings has won the 2001 NORBA Downhill Overall Title (with Maxxis pilot John Kirkcaldie), as well as numerous NORBA NCS and UCI Downhill podium spots.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/highroller/hr-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Know your knobs</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Center groove for straight-line traction. Ramped specific knob design - front or rear, direction specific. Ideal for hardpack, loose-over-hardpack, and medium soil.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/highroller/hr-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>Slow Reezay- compound (40a) which allow's the tire to rebound much slower than a conventional tire, offering maximum grip and is the softest compound available.</p>
          <!-- InstanceEndEditable -->
