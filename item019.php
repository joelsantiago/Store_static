...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Thule 916XT T2 2-inch Receiver Bike Carrier</title>
    <!-- InstanceEndEditable -->
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Thule 916XT T2 2-inch Receiver Bike Carrier<hr/></h4>
        <!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item018.php" class="small button expand">1.25 Receiver"</a>
            <a href="#" class="small button expand">2" Receiver</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=19" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
