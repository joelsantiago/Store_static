...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Tarantino XX Collection Blu-ray</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/movies/XX.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=31" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-3 small-6 columns">
      ...
      <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item027.php">
      <img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/apocalypsenow.gif" width="500" height="500"></a>

      <div class="panel">

        <p><a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item027.php">Apocalypse Now</a></p>
