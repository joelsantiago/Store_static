...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>ARB On-Board High Performance 12 Volt Twin Air Compressor (CKMTA12)</title>
    <!-- InstanceEndEditable -->
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">ARB On-Board High Performance 12 Volt Twin Air Compressor (CKMTA12)<hr/></h4>
        <!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="#" class="small button expand">12-Volt</a>
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item002.php" class="small button expand">24-Volt</a>
            <!-- InstanceEndEditable -->
