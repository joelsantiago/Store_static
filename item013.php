...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Fox Racing Shox 32 Talas Adjustable Suspension Fork with 15mm Quick-Release</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/cycling/talas/talas-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Fox Racing Shox 32 Talas Adjustable Suspension Fork<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">The Fox 32 Talas 140 FIT CTD adjustable suspension fork offers a plush 140mm of travel with a veritable bevy of adjustments, enabling "just right" tunability that would make Goldilocks jealous.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="#" class="small button expand" disabled>Option 1</a>
            <a href="#" class="small button expand" disabled>Option 2</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=13" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/talas/talas-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>Float down the trail</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Float FIT (Fox Isolated Technology) uses a bladder system within the fork to ensure that the air does not mix with the oil, maximizing performance and consistent damping</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/talas/talas-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Crazy levels of adjustment</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Talas 2-position travel adjustment switches between 110mm and the full 140mm of travel; 110mm position drops the front end to improve weight balance and efficency for climbing</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/talas/talas-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Ready for any terrain</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>CTD damper system—Climb, Trail, Descend—offers 3 positions to simplify setting up the fork's suspension response and performance</p>
          <!-- InstanceEndEditable -->
