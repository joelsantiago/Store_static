...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/electronics/hifi/hifi-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">HIFIman HE-400<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">The headphone industry has many newcomers, but few have distinguished themselves as much as HiFiMAN. They have wowed listeners with their planar magnetic driver design, which produces warm, dynamic sound across a wide soundstage. The HE-400 is their entry-level planar headphone, letting you experience the planar advantage at an affordable price.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=26" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hifi/hifi-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>Planar Technology</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Unlike dynamic drivers used in most headphones and speakers, planar drivers use thin flexible diaphragms with voice coils etched onto their surface rather than a voice coil attached to a cone. This exceptionally lightweight structure uses a large driver surface area to reproduce your music with openness and detail that are difficult to achieve with conventional designs. </p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hifi/hifi-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Cable Disconnects</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>The high-quality headphone cable — another hallmark of HiFiMAN's dedication to great sound — attaches to each earcup, making it easy to swap it out for a custom or aftermarket cord.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hifi/hifi-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Listen for hours</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>Soft earpads and a cushioned headband allow you to enjoy the HE-400's tight bass and smooth treble for hours at a time. </p>
          <!-- InstanceEndEditable -->
  ...
  <div class="row">
    ...
    <div class="large-3 small-6 columns">
      ...
      <div class="panel">
        ...
        <p><a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item024.php
        ">GoPro Hero 3 Silver</a></p>
