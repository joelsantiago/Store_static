...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Maxxis High Roller Mountain Bike Tire Folding 60a</title>
    <!-- InstanceEndEditable -->
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Maxxis High Roller Mountain Bike Tire Folding 60a<hr/></h4>
        <!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="#" class="small button expand">Folding 60a</a>
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=14" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
