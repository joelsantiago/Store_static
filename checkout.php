        ...
        <legend>Shipping Info</legend>
          <div class="row">
            ...
            <div class="large-6 columns right">
              <strong><u>Shipping Choice</u></strong>         
              <!--<label for="radio1"><input name="next_day" type="radio" id="radio"> Next Day Shipping - $14.99</label>
              <label for="radio1"><input name="2_day" type="radio" id="radio"> 2 Day Shipping - $9.99</label>
              <label for="radio1"><input name="3_day" type="radio" id="radio"> 3 Day Shipping - $4.99</label>
              <label for="radio1"><input name="standard" type="radio" id="radio"> Standard Shipping - $2.99</label>-->
              <?php
			 	echo '<br>';
