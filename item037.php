...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Hobart Ironman 230 Mig Welder</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/tools/welder/welder-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Hobart Ironman 230 Mig Welder<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">This exceptional value pairs the Hobart Ironman 230 MIG Welder with a 20-Feet, 200 Amp Spoolgun resulting in one powerful welding package. You get both 15-Feet, 200 AMP MIG gun and a 20-Feet, 200 AMP Spoolgun with this offer. Whether you are a professional or just want to weld like one, choose the IronMan 230 delivering professional-grade arc-quality, voltage control and duty cycle for a great value. The included spoolgun makes aluminum MIG welding very reliable.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=37" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/welder/welder-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>It's got rolls</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Reversible drive rolls: two grooves for two wire sizes on one drive roll. Decreases spare parts and changeover time</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/welder/welder-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Rolling Internals</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Unique spool hub makes changing from 2, 10, 33 and 45 lb. wires spools a snap with a tool-less brake tension knob and automatic wire alignment</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/welder/welder-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>He's got a (spool) gun!</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>Comes complete with 200 amp gun and built-in running gear/cylinder rack.  Infinite wire feed speed control for precise adjustment of penetration and weld bead shape</p>
          <!-- InstanceEndEditable -->
