...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/electronics/hero3/black/black-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="#" class="small button expand">Black</a>
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=23" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hero3/black/black-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/electronics/hero3/black/black-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Wi-Fi Remote Included</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>The Wi-Fi Remote is waterproof, wearable and can control up to 50 Wi-Fi-enabled GoPros at a time from a range of 600'. The HERO3's built in Wi-Fi means it can also be controlled by iOS smartphones and tablets running the GoPro App.</p>
          <!-- InstanceEndEditable -->
