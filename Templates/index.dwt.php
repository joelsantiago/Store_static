...
<!-- Navigation -->
  ...
  <div class="row buffer">
    <div class="large-12 columns">
      ...
      <img src="http://placehold.it/1000x400&text=Header">
	  <!-- TemplateEndEditable -->	      
      <hr>
    </div>
  </div>
            ...
            <div class="large-12 columns">
              <div class="panel">
                <div class="row">
                  ...
                  <div class="columns">
                  	<!-- TemplateBeginEditable name="header title" -->
                    <h1 class="nobottom-centered">Category Heading</h1>
 					<p>Risus ligula, aliquam nec fermentum vitae, sollicitudin eget urna. Donec dignissim nibh fermentum odio ornare sagittis</p>
                    <!-- TemplateEndEditable -->
                  </div>
        ...
        <div class="large-12 columns">
          <div class="row">
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product1" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable -->              
              <div class="panel">
              	<!-- TemplateBeginEditable name="product1 info" -->
                <h5>Item Name</h5>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product2" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable --> 
              <div class="panel">
              	<!-- TemplateBeginEditable name="product2 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
				<!-- TemplateEndEditable -->
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product3" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable -->
              <div class="panel">
              	<!-- TemplateBeginEditable name="product3 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
			  <!-- TemplateEndEditable -->
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product4" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable --> 
              <div class="panel">
              	<!-- TemplateBeginEditable name="product4 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
			  <!-- TemplateEndEditable -->
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product5" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable -->
              <div class="panel">
              	<!-- TemplateBeginEditable name="product5 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
			  <!-- TemplateEndEditable -->              
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product6" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
 			  <!-- TemplateEndEditable -->
              <div class="panel">
              	<!-- TemplateBeginEditable name="product6 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
                <!-- TemplateEndEditable -->
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product7" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable --> 
              <div class="panel">
              	<!-- TemplateBeginEditable name="product7 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
			  <!-- TemplateEndEditable -->
              </div>
            ...
            <div class="large-3 small-6 columns">
			  <!-- TemplateBeginEditable name="product8" -->
              <img src="http://placehold.it/500x500&text=Thumbnail">
			  <!-- TemplateEndEditable -->
              <div class="panel">
              	<!-- TemplateBeginEditable name="product8 info" -->              
                <h5>Item Name</h5>
                <h6 class="subheader">$000.00</h6>
			  <!-- TemplateEndEditable -->              
              </div>
