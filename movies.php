...
<!-- Navigation -->
  ...
  <div class="row buffer">
    <div class="large-12 columns">
      ...
      <img src="img/headers/movies-header.gif">
	  <!-- InstanceEndEditable -->	      
      <hr>
    </div>
  </div>
              ...
              <div class="panel">
                <div class="row">
                  ...
                  <div class="columns">
                    ...
                    <h1 class="nobottom-centered">Movies</h1>
					<p>Whatever your tastes may be, we have just the selection to get you ready for any movie night.  Action, adventure, comedy, horror, sci-fi?  Pick a section and take a look to see what movies might pique your interest.  Maybe you'll find something special that you've never seen before.</p>
                    <!-- InstanceEndEditable -->
                  </div>
        ...
        <div class="large-12 columns">
          <div class="row">
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item027.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/apocalypsenow.gif"></a>
			  <!-- InstanceEndEditable -->              
              <div class="panel">
              	<!-- InstanceBeginEditable name="product1 info" -->
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item027.php"><h5>Apocalypse Now Blu-ray</h5></a>
                <h6 class="subheader">Price: $19.99</h6>
				<!-- InstanceEndEditable --> 
              </div>
            </div>
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item028.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/bladerunner.gif"></a>
			  <!-- InstanceEndEditable --> 
              <div class="panel">
              	<!-- InstanceBeginEditable name="product2 info" -->              
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item028.php"><h5>Blade Runner Blu-ray</h5></a>
                <h6 class="subheader">Price: $24.99</h6>
				<!-- InstanceEndEditable -->
              </div>
            </div>
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item029.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/serenity.gif"></a>
			  <!-- InstanceEndEditable -->
              <div class="panel">
              	<!-- InstanceBeginEditable name="product3 info" -->              
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item029.php"><h5>Serenity Limited Edition Blu-ray</h5></a>
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item030.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/shaunofthedead.gif"></a>
			  <!-- InstanceEndEditable --> 
              <div class="panel">
              	<!-- InstanceBeginEditable name="product4 info" -->              
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item030.php"><h5>Shaun of the Dead Blu-ray</h5></a>
                <h6 class="subheader">Price: $14.99</h6>
			  <!-- InstanceEndEditable -->
              </div>
            </div>
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item031.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/XX.gif"></a>
			  <!-- InstanceEndEditable -->
              <div class="panel">
              	<!-- InstanceBeginEditable name="product5 info" -->              
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item031.php"><h5>Tarantino XX Collection Blu-ray</h5></a>
                <h6 class="subheader">Price: $79.99</h6>
			  <!-- InstanceEndEditable -->              
              </div>
            </div>
            ...
            <div class="large-3 small-6 columns">
              ...
              <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item032.php"><img src="http://puzzle.sci.csueastbay.edu/~qy2554/Store/img/movies/biglebowski.gif"></a>
 			  <!-- InstanceEndEditable -->
              <div class="panel">
              	<!-- InstanceBeginEditable name="product6 info" -->              
                <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item032.php"><h5>The Big Lebowski Blu-ray</h5></a>
                <h6 class="subheader">Price: $11.99</h6>
                <!-- InstanceEndEditable -->
              </div>
            </div>
