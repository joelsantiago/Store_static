...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Apple Macbook Air 13" Inch</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/electronics/mba/mba-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Apple Macbook Air 13" Inch<hr/></h4>
        <!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="large-6 small-6 columns">
          <div class="panel">
            ...
            <a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item020.php" class="small button expand">11-inch</a>
            <a href="#" class="small button expand">13-inch</a>
            <!-- InstanceEndEditable -->
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=21" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
