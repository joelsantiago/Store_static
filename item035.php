...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>DeWalt D2840 Angle Grinder</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/tools/grinder/grinder-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">DeWalt D2840 Angle Grinder<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">The DEWALT 4-1/2 in. Small Angle Grinder features a 10 Amp AC/DC motor designed for fast material removal and high overload protection. This motor generates 11,000 RPM for powerful grinding. The low-profile gear case allows precise gear alignment for a smoother, quieter transmission while also giving access to tight spaces. The Quick-Change wheel release provides easy and quick wheel removal without a wrench, while the removable, vibration-reducing side handle offers a comfortable grip.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=35" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/grinder/grinder-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>Vibration-reducing, removable side handle provides a comfortable grip</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/grinder/grinder-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>4 1/2 Inch Grinding Wheel</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Quick-Change wheel release provides easy and quick wheel removal without a wrench</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/grinder/grinder-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>10.0 Amp AC/DC motor designed for fast material removal and high overload protection that runs up to 11,000 RPM for powerful grinding</p>
          <!-- InstanceEndEditable -->
