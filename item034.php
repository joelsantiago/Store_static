...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>DeWalt DW891 Metal Shears</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/tools/shears/shears-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">DeWalt DW891 Metal Shears<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">The DW891 sports an extremely efficient all ball-bearing motor, which puts out 5.0 amps of power. It's hard to argue with a power tool capable of 2,500 strokes per minute, especially when its head rotates 360 angles. Plus, when you are cutting, the excess continuously curls so it stays out of your line of sight.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=34" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/shears/shears-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>Powerful, 5.0 Amp, all ball-bearing motor for long life and a swiveling head for convenient cuts in various directions.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/shears/shears-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Convenient Cuts</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Cuts 7/32" strip which continuously curls out of cutting area for clear line of sight</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/tools/shears/shears-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Replaceable Blades</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>Replacement blades are available to improve cut quality when old blades become blunt.</p>
          <!-- InstanceEndEditable -->
