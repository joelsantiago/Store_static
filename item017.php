...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>SRAM X0 Type-2 10 Speed Rear Derailleur</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/cycling/X0/X0-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">SRAM X0 Type-2 10 Speed Rear Derailleur<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">Designed for X0 and X9 families, TYPE 2 rear derailleur delivers maximum drivetrain stability—even through the most punishing technical terrain. With Roller Bearing Clutch™ technology, SRAM TYPE 2 eliminates derailleur bounce and chain slap without sacrificing precision.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=17" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/X0/X0-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
        ...
        <!-- InstanceEndEditable -->
          ...
          <p>When we launched our road technology from scratch we reapplied our MTB proven SRAM 1:1 actuation ratio (shifter cable travel : derailleur movement) for 10 speed rear shifting. EA helps to simplify/stabilize the uneasy act of balancing rear derailleur hanger design, tight cog spacing and exact cable tension. The result: the easiest index shifting system to set up and it stays that way.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/X0/X0-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Direct Route Technology</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Here's the dirt on middlemen: they suck. That's why Direct Route Technology™ doesn't have one. Instead, the cable routes directly to the actuation mechanism. Result? Less friction. Less effort. More oomph. Plus it's impervious to cable housing damage. Nice.</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/X0/X0-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Cage lock Technology</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>The first rear derailleur of its kind, SRAM TYPE 2 lets you push your cage forward and lock it into place with the push of a button. This creates slack, removing all tension from the chain. With Cage Lock, TYPE 2 makes wheel removal and installation—
as well as chain installation—easier than any other derailleur on earth.</p>
          <!-- InstanceEndEditable -->
  ...
  <div class="row">
    ...
    <div class="large-3 small-6 columns">
      ...
      <div class="panel">
        ...
        <p><a href="http://puzzle.sci.csueastbay.edu/~qy2554/Store/item011.php">Crank Bros. Mallet</a></p>
