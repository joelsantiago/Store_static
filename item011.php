...
<html lang="en"><!-- InstanceBegin template="/Templates/item.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Crank Brothers Mallet 2</title>
    <!-- InstanceEndEditable -->
...
<div class="fixed"> 
  ...
  <div class="row buffer">
    ...
    <div class="large-6 columns">
      ...
      <img src="img/cycling/mallet/mallet-main.gif" width="500" height="500"/><br>
	  <!-- InstanceEndEditable -->
    </div>
    ...
    <div class="large-6 columns">
      <div class="panel">
        ...
        <h4 class="hide-for-small">Crank Brothers Mallet 2<hr/></h4>
        <!-- InstanceEndEditable -->
        
        <!-- InstanceBeginEditable name="Main Product Description" -->
      	<h5 class="subheader">Ready for the trails, the crankbrothers Mallet 2 bike pedals offer a wide platform, easy cleat engagement and adjustable pins for downhill or race use.
		</h5>
        <!-- InstanceEndEditable -->
      </div>
      ...
      <div class="row">
        ...
        <div class="large-6 small-6 columns">
          ...
          <!--
            ...
            <a href="cart.php?action=add&ItemID=11" class="small button expand">Add to cart</a>
            <!-- InstanceEndEditable -->
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/mallet/mallet-sub1.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      	
        <!-- InstanceBeginEditable name="Additional Title 1" -->
        <h4>Solid construction</h4>
        <!-- InstanceEndEditable -->
          
          <!-- InstanceBeginEditable name="Additional Description 1" -->
          <p>Pedal bodies are made of aluminum and stamped steel for lasting, dependable performance with a wide platform for extra stability underfoot</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/mallet/mallet-sub2.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 2" -->
        <h4>Clip in / Clip out</h4>
        <!-- InstanceEndEditable -->

		  <!-- InstanceBeginEditable name="Additional Description 2" -->        
          <p>Easy 4-sided entry into the cleat-retention mechanism makes these pedals a snap to engage with the included premium brass crankbrothers cleats (included)</p>
          <!-- InstanceEndEditable -->
    ...
    <div class="large-4 columns">
      ...
      <img src="img/cycling/mallet/mallet-sub3.gif" width="400" height="300"/>
      <!-- InstanceEndEditable -->
      
        <!-- InstanceBeginEditable name="Additional Title 3" -->
        <h4>Grip in any terrain</h4>
        <!-- InstanceEndEditable -->
        
		  <!-- InstanceBeginEditable name="Additional Description 3" -->        	
          <p>12 screw pins provide adjustable traction to meet your grip preferences</p>
          <!-- InstanceEndEditable -->
